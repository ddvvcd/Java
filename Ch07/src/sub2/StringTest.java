...
public class StringTest {
	public static void main(String[] args) {
		...
		System.out.println("msg 1번째 문자 : " + msg.charAt(6));
		...
		String s1 = String.valueOf(var1); //클래스 메서드 = 정적 메서드 (바로 참조)
		String s2 = String.valueOf(var2);
		String s3 = ""+var3; //중요함 (이렇게 간략하게 작성)
