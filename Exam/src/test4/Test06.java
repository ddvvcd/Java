...
public class Test06 {
	public static void main(String[] args) {
		...
		Apple apple = new Apple("한국", 3000);  //이 3개의 부모변수를 생각하기
	...
	public void showInfo(Object fruit) { //부모변수는 Object //업캐스팅
		
		if(fruit instanceof Apple) { //
			Apple apple = (Apple) fruit; //Object 타입을 상속받은 사과->fruit로 다운캐스팅
			apple.show();
